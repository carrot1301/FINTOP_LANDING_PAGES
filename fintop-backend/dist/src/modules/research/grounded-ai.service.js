...
var GroundedAiService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.GroundedAiService = void 0;
const common_1 = require("@nestjs/common");
const config_1 = require("@nestjs/config");
let GroundedAiService = GroundedAiService_1 = class GroundedAiService {
    configService;
    logger = new common_1.Logger(GroundedAiService_1.name);
    constructor(configService) {
        this.configService = configService;
    }
    async generate(data, language = 'vi') {
...
${JSON.stringify(data, null, 2)}`;
    ...
    generateLocalFallback(data, language) {
...
exports.GroundedAiService = GroundedAiService;
exports.GroundedAiService = GroundedAiService = GroundedAiService_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [config_1.ConfigService])
], GroundedAiService);
//# sourceMappingURL=grounded-ai.service.js.map