...
let AdminController = class AdminController {
    ...
    async getUsers(page, limit, search, status, userType, tierLevel, roleCode) {
    ...
    async assignRole(id, roleCode, admin, staffCode) {
    ...
    async createReport(dto, admin) {
        return this.adminService.createReport(dto, admin.id);
    }
    async updateReport(id, dto, admin) {
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'roleCode', required: false, description: 'Filter by specific role code' }),
    ...
    __param(6, (0, common_1.Query)('roleCode')),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiBody)({ schema: { properties: { roleCode: { type: 'string' }, staffCode: { type: 'string' } } } }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)('roleCode')),
    __param(2, (0, current_user_decorator_1.CurrentUser)()),
    __param(3, (0, common_1.Body)('staffCode')),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, permissions_decorator_1.Permissions)('REPORT:CREATE'),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new report file' }),
...
__decorate([
    ...
    (0, permissions_decorator_1.Permissions)('REPORT:UPDATE'),
    (0, swagger_1.ApiOperation)({ summary: 'Update a report file' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __param(2, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, permissions_decorator_1.Permissions)('REPORT:DELETE'),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a report file' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
