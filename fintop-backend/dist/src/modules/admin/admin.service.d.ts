...
export declare class AdminService {
    ...
    private static readonly CEO_EMAILS;
    ...
    getUsers(page?: number, limit?: number, search?: string, status?: string, userType?: string, tierLevel?: string, roleCode?: string): Promise<{
        data: {
            roles: {
                name: string;
    ...
    assignRole(userId: number, roleCode: string, adminId: number, staffCode?: string): Promise<{
        message: string;
        userId: number;
        roleCode: string;
    }>;
    ...
    createReport(dto: any, adminId: number): Promise<{
        status: import("@prisma/client").$Enums.BLOG_STATUS;
        id: number;
        source: string | null;
        createdAt: Date;
    ...
    updateReport(id: number, dto: any, adminId: number): Promise<{
        status: import("@prisma/client").$Enums.BLOG_STATUS;
        id: number;
        source: string | null;
        createdAt: Date;
    ...
    deleteReport(id: number, adminId: number): Promise<{
        status: import("@prisma/client").$Enums.BLOG_STATUS;
        id: number;
        source: string | null;
        createdAt: Date;
