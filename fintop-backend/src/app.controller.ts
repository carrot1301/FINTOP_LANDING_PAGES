...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  ...
  @Get('googleffe9b2e8d0ffe423.html')
  @Get('blogs/share/googleffe9b2e8d0ffe423.html')
  getGoogleVerification(@Res() res: any) {
