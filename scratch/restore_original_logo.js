...
const mailServiceCode = `import { Injectable, Logger } from '@nestjs/common';
...
fs.writeFileSync('./fintop-backend/src/common/mail/mail.service.ts', mailServiceCode);
console.log('Restored original logo template structure with LogoFinTop_notbg.jpg');
